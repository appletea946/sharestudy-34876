...
ActiveRecord::Schema.define(version: 2021_03_29_070213) do
  ...
  create_table "article_group_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "article_id"
    t.bigint "group_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_article_group_relations_on_article_id"
    t.index ["group_id"], name: "index_article_group_relations_on_group_id"
  end
  ...
  add_foreign_key "article_group_relations", "articles"
  add_foreign_key "article_group_relations", "groups"
